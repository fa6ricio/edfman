...
If lOk .And. mv_par32 < 15
		ShowHelpDlg("MINQTDELIN", {"Valor informado inválido do","'Num. linhas p/ o razão'"},5,{"Favor preencher uma quantidade","mínima de 15 linhas"},5)   
		lOk := .F.
EndIf
...
If lOk
	If lImpRazR4
		...
		CTBR400R4(aCtbMoeda,lCusto,lItem,lCLVL,@cArqTmp,aSelFil,lTodasFil, lProcSld, cTmpProc )
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function CTBR400R4(aCtbMoeda,lCusto,lItem,lCLVL,cArqTmp,aSelFil,lTodasFil, lProcSld, cTmpProc  )
Default lProcSld := .F.
Default cTmpProc := "" 	
...
// oSection2
oSection2 := TRSection():New(oReport,STR0044,{"cArqTmp","CT2"},/*aOrder*/,/*lLoadCells*/,/*lLoadOrder*/,,,,,,.F.)	//"Custo"
...
If cTpValor != "P"
	TRCell():New(oSection2,"CLANCDEB"	,"cArqTmp",STR0037+" "+aCtbMoeda[3],/*Picture*/,TAM_VALOR,/*lPixel*/,{|| ValorCTB(cArqTmp->LANCDEB,,,TAM_VALOR,nDecimais,.F.,cPicture,"1",,,,,,lPrintZero,.F.) },/*"RIGHT"*/,,"CENTER",,,.F.)// "DEBITO"
	TRCell():New(oSection2,"CLANCCRD"	,"cArqTmp",STR0038+" "+aCtbMoeda[3],/*Picture*/,TAM_VALOR,/*lPixel*/,{|| ValorCTB(cArqTmp->LANCCRD,,,TAM_VALOR,nDecimais,.F.,cPicture,"2",,,,,,lPrintZero,.F.) },/*"RIGHT"*/,,"CENTER",,,.F.)// "CREDITO"
	TRCell():New(oSection2,"CTPSLDATU"	,"cArqTmp",STR0039+" "+aCtbMoeda[3],/*Picture*/,TAM_VALOR+2,/*lPixel*/,/*{|| }*/,/*"RIGHT"*/,,"CENTER",,,.F.)// "SALDO ATUAL"
    // 20/08/18 - Luis Felipe -Inicio
	TRCell():New(oSection2,"CLANCDEB1"	,"cArqTmp",STR0037+" U$",/*Picture*/,TAM_VALOR,/*lPixel*/,{|| ValorCTB(cArqTmp->LANCDEB_1,,,TAM_VALOR,nDecimais,.F.,cPicture,"1",,,,,,lPrintZero,.F.) },/*"RIGHT"*/,,"CENTER",,,.F.)// "DEBITO"
	TRCell():New(oSection2,"CLANCCRD1"	,"cArqTmp",STR0038+" U$",/*Picture*/,TAM_VALOR,/*lPixel*/,{|| ValorCTB(cArqTmp->LANCCRD_1,,,TAM_VALOR,nDecimais,.F.,cPicture,"2",,,,,,lPrintZero,.F.) },/*"RIGHT"*/,,"CENTER",,,.F.)// "CREDITO"
	TRCell():New(oSection2,"CTPSLDATU1"	,"cArqTmp",STR0039+" U$",/*Picture*/,TAM_VALOR+2,/*lPixel*/,/*{|| }*/,/*"RIGHT"*/,,"CENTER",,,.F.)// "SALDO ATUAL"
    // 20/08/18 - Luis Felipe -Fim
Else
	TRCell():New(oSection2,"CLANCDEB"	,"cArqTmp",STR0037+" "+aCtbMoeda[3],/*Picture*/,TAM_VALOR,/*lPixel*/,{|| ValorCTB(cArqTmp->LANCDEB,,,TAM_VALOR,nDecimais,.F.,cPicture,"1",,,,,,lPrintZero,.F.) },"RIGHT",,"RIGHT",,,.F.)// "DEBITO"
	TRCell():New(oSection2,"CLANCCRD"	,"cArqTmp",STR0038+" "+aCtbMoeda[3],/*Picture*/,TAM_VALOR,/*lPixel*/,{|| ValorCTB(cArqTmp->LANCCRD,,,TAM_VALOR,nDecimais,.F.,cPicture,"2",,,,,,lPrintZero,.F.) },"RIGHT",,"RIGHT",,,.F.)// "CREDITO"
	TRCell():New(oSection2,"CTPSLDATU"	,"cArqTmp",STR0039+" "+aCtbMoeda[3],/*Picture*/,TAM_VALOR+2,/*lPixel*/,/*{|| }*/,"RIGHT",,"RIGHT",,,.F.)// "SALDO ATUAL"
    // 20/08/18 - Luis Felipe -Inicio
	TRCell():New(oSection2,"CLANCDEB1"	,"cArqTmp",STR0037+" U$",/*Picture*/,TAM_VALOR,/*lPixel*/,{|| ValorCTB(cArqTmp->LANCDEB_1,,,TAM_VALOR,nDecimais,.F.,cPicture,"1",,,,,,lPrintZero,.F.) },"RIGHT",,"RIGHT",,,.F.)// "DEBITO"
	TRCell():New(oSection2,"CLANCCRD1"	,"cArqTmp",STR0038+" U$",/*Picture*/,TAM_VALOR,/*lPixel*/,{|| ValorCTB(cArqTmp->LANCCRD_1,,,TAM_VALOR,nDecimais,.F.,cPicture,"2",,,,,,lPrintZero,.F.) },"RIGHT",,"RIGHT",,,.F.)// "CREDITO"
	TRCell():New(oSection2,"CTPSLDATU1"	,"cArqTmp",STR0039+" U$",/*Picture*/,TAM_VALOR+2,/*lPixel*/,/*{|| }*/,"RIGHT",,"RIGHT",,,.F.)// "SALDO ATUAL"
    // 20/08/18 - Luis Felipe -Fim
EndIf    
...
// 20/08/18 - Luis Felipe -Inicio
oSection2:Cell("CLANCDEB1"):lHeaderSize	:= .F.
oSection2:Cell("CLANCCRD1"):lHeaderSize	:= .F.
oSection2:Cell("CTPSLDATU1"):lHeaderSize	:= .F.     
// 20/08/18 - Luis Felipe -Fim
...
// 20/08/18 - Luis Felipe -Inicio
TRCell():New(oSection1_1,"SALDOANT1","cArqTmp","",/*Picture*/,TAM_VALOR + 20,/*lPixel*/,{|| },"RIGHT",,"RIGHT")
// 20/08/18 - Luis Felipe -Fim
...
If lNumAsto .and. nTipoRel == 1
	TRCell():New(oSection2,"NASIENTO"	,""		  ,"Nro Asiento",/*Picture*/,15		,/*lPixel*/,{|| cArqTmp->NASIENTO},"CENTER",.T.,"CENTER",,,.F.)// Número asiento
EndIf
...
If cTpValor != "P"
	TRCell():New(oSection3,"CLANCDEB"	,"cArqTmp",STR0037+" "+aCtbMoeda[3],/*Picture*/,TAM_VALOR,/*lPixel*/,,/*"RIGHT"*/,,"CENTER",,,.F.)// "DEBITO"
	TRCell():New(oSection3,"CLANCCRD"	,"cArqTmp",STR0038+" "+aCtbMoeda[3],/*Picture*/,TAM_VALOR,/*lPixel*/,,/*"RIGHT"*/,,"CENTER",,,.F.)// "CREDITO"
    // 20/08/18 - Luis Felipe - Inicio
	TRCell():New(oSection3,"CLANCDEB1"	,"cArqTmp",STR0037+" U$",/*Picture*/,TAM_VALOR,/*lPixel*/,,/*"RIGHT"*/,,"CENTER",,,.F.)// "DEBITO"
	TRCell():New(oSection3,"CLANCCRD1"	,"cArqTmp",STR0038+" U$",/*Picture*/,TAM_VALOR,/*lPixel*/,,/*"RIGHT"*/,,"CENTER",,,.F.)// "CREDITO"
    // 20/08/18 - Luis Felipe - fim
Else
	TRCell():New(oSection3,"CLANCDEB"	,"cArqTmp",STR0037+" "+aCtbMoeda[3],/*Picture*/,TAM_VALOR,/*lPixel*/,,"RIGHT",,"RIGHT",,,.F.)// "DEBITO"
	TRCell():New(oSection3,"CLANCCRD"	,"cArqTmp",STR0038+" "+aCtbMoeda[3],/*Picture*/,TAM_VALOR,/*lPixel*/,,"RIGHT",,"RIGHT",,,.F.)// "CREDITO"
    // 20/08/18 - Luis Felipe - Inicio
	TRCell():New(oSection3,"CLANCDEB1"	,"cArqTmp",STR0037+" U$",/*Picture*/,TAM_VALOR,/*lPixel*/,,"RIGHT",,"RIGHT",,,.F.)// "DEBITO"
	TRCell():New(oSection3,"CLANCCRD1"	,"cArqTmp",STR0038+" U$",/*Picture*/,TAM_VALOR,/*lPixel*/,,"RIGHT",,"RIGHT",,,.F.)// "CREDITO"
    // 20/08/18 - Luis Felipe - fim
EndIf
...
// 20/08/18 - Luis Felipe - Inicio
oSection3:Cell("CLANCDEB1"):Hide()
oSection3:Cell("CLANCCRD1"):Hide()
// 20/08/18 - Luis Felipe - Fim

If lNumAsto .and. nTipoRel == 1
	oSection2:Cell("NASIENTO"):SetSize(15)
EndIf
...
If lImpLivro
	...
	If IsBlind()
		CTBGerRaz(,,,,@cArqTmp,cContaIni,cContaFim,cCustoIni,cCustoFim,;
								...
								aSetOfBook,lNoMov,cSaldo,lJunta,"1",lAnalitico,"02",,cFiltro,lSldAnt,aSelFil, .T.)  // 20/08/18 - Luis Felipe "02"

	Else
		MsgMeter({|	oMeter, oText, oDlg, lEnd | CTBGerRaz(	oMeter,oText,oDlg,lEnd,@cArqTmp,cContaIni,cContaFim,cCustoIni,cCustoFim,;
								cItemIni,cItemFim,cCLVLIni,cCLVLFim,cMoeda,dDataIni,dDataFim,;
								aSetOfBook,lNoMov,cSaldo,lJunta,"1",lAnalitico,"02",,cFiltro,lSldAnt,aSelFil) },; // 20/08/18 - Luis Felipe "02"
...
If cTpValor != "P"
	...
	// 20/08/18 - Luis Felipe - Inicio
	oTotDeb1 	:= TRFunction():New( oSection2:Cell("CLANCDEB1")	, ,"ONPRINT", oBrkConta,/*Titulo*/,cPicture,;
						{ || ValorCTB(nTotDeb1  ,,,TAM_VALOR,nDecimais,.F.,cPicture,"1",,,,,,lPrintZero,.F.) },.F.,.F.,.F.,oSection2)

	oTotCred1	:= TRFunction():New( oSection2:Cell("CLANCCRD1")	, ,"ONPRINT", oBrkConta,/*Titulo*/,cPicture,;
						{ || ValorCTB(nTotCrd1  ,,,TAM_VALOR,nDecimais,.F.,cPicture,"2",,,,,,lPrintZero,.F.) },.F.,.F.,.F.,oSection2)
	If lIsRedStor
		oTotTpSld2 	:= TRFunction():New( oSection2:Cell("CTPSLDATU1")	, ,"ONPRINT", oBrkConta,/*Titulo*/,cPicture,;
							{ || ValorCTB(RedStorTt(nTotDeb1,nTotCrd1,,cNormal,"D"),,,TAM_VALOR-2,nDecimais,.T.,cPicture,cNormal,,,,,,lPrintZero,.F.,lColDbCr)},.F.,.F.,.F.,oSection2)
	Else
		oTotTpSld2 	:= TRFunction():New( oSection2:Cell("CTPSLDATU1")	, ,"ONPRINT", oBrkConta,/*Titulo*/,cPicture,;
							{ || ValorCTB(nSaldoAtu1,,,TAM_VALOR-2,nDecimais,.T.,cPicture,cNormal,,,,,,lPrintZero,.F.)},.F.,.F.,.F.,oSection2)
	EndIF
	// 20/08/18 - Luis Felipe - Fim
...
Else
	...
	oTotCred	:= TRFunction():New( oSection2:Cell("CLANCCRD")	, ,"ONPRINT", oBrkConta,/*Titulo*/,cPicture,;
						{ || PadL(ValorCTB(nTotCrd  ,,,TAM_VALOR,nDecimais,.F.,cPicture,"2",,,,,,lPrintZero,.F.,lColDbCr),TAM_VALOR) },.F.,.F.,.F.,oSection2)
	
	If lIsRedStor
		oTotTpSld21 	:= TRFunction():New( oSection2:Cell("CTPSLDATU")	, ,"ONPRINT", oBrkConta,/*Titulo*/,cPicture,;
    ...
    // 20/08/18 - Luis Felipe - Inicio
	oTotDeb1	:= TRFunction():New( oSection2:Cell("CLANCDEB1")	, ,"ONPRINT", oBrkConta,/*Titulo*/,cPicture,;
						{ || PadL(ValorCTB(nTotDeb1  ,,,TAM_VALOR,nDecimais,.F.,cPicture,"1",,,,,,lPrintZero,.F.),TAM_VALOR) },.F.,.F.,.F.,oSection2)

	
	oTotCred1	:= TRFunction():New( oSection2:Cell("CLANCCRD1")	, ,"ONPRINT", oBrkConta,/*Titulo*/,cPicture,;
						{ || PadL(ValorCTB(nTotCrd1  ,,,TAM_VALOR,nDecimais,.F.,cPicture,"2",,,,,,lPrintZero,.F.,lColDbCr),TAM_VALOR) },.F.,.F.,.F.,oSection2)
	
	If lIsRedStor
		oTotTpSld21 	:= TRFunction():New( oSection2:Cell("CTPSLDATU1")	, ,"ONPRINT", oBrkConta,/*Titulo*/,cPicture,;
							{ || PadL(ValorCTB(RedStorTt(nTotDeb1,nTotCrd1,,cNormal,"D"),,,TAM_VALOR-2,nDecimais,.T.,cPicture,cNormal,,,,,,lPrintZero,.F.,lColDbCr),TAM_VALOR+2)},.F.,.F.,.F.,oSection2)
	Else
		oTotTpSld21 	:= TRFunction():New( oSection2:Cell("CTPSLDATU1")	, ,"ONPRINT", oBrkConta,/*Titulo*/,cPicture,;
							{ || PadL(ValorCTB(nSaldoAtu1,,,TAM_VALOR,nDecimais,.T.,cPicture,cNormal,,,,,,lPrintZero,.F.),TAM_VALOR+2)},.F.,.F.,.F.,oSection2)
	Endif 
    // 20/08/18 - Luis Felipe - fim
...
If lImpLivro .And. mv_par28 == 1	//Imprime total Geral
	...
	If cTpValor != "P"
		...
		// 20/08/18 - Luis Felipe - Inicio
		oTotGerDeb1 	:= TRFunction():New( oSection2:Cell("CLANCDEB1")	, ,"ONPRINT", oBrkEnd,/*Titulo*/,cPicture,;
					{ || ValorCTB(nTotGerDeb1  ,,,TAM_VALOR,nDecimais,.F.,cPicture,"1",,,,,,lPrintZero,.F.) },.F.,.F.,.F.,oSection2)
		oTotGerCred1	:= TRFunction():New( oSection2:Cell("CLANCCRD1")	, ,"ONPRINT", oBrkEnd,/*Titulo*/,cPicture,;
					{ || ValorCTB(nTotGerCrd1  ,,,TAM_VALOR,nDecimais,.F.,cPicture,"2",,,,,,lPrintZero,.F.) },.F.,.F.,.F.,oSection2)
		// 20/08/18 - Luis Felipe - Fim 
	...
	Else
		...
		// 20/08/18 - Luis Felipe - Inicio
		oTotGerDeb1 	:= TRFunction():New( oSection2:Cell("CLANCDEB1")	, ,"ONPRINT", oBrkEnd,/*Titulo*/,cPicture,;
					{ || PADL(ValorCTB(nTotGerDeb1  ,,,TAM_VALOR,nDecimais,.F.,cPicture,"1",,,,,,lPrintZero,.F.),TAM_VALOR) },.F.,.F.,.F.,oSection2)
		oTotGerCred1 := TRFunction():New( oSection2:Cell("CLANCCRD1")	, ,"ONPRINT", oBrkEnd,/*Titulo*/,cPicture,;
					{ || PADL(ValorCTB(nTotGerCrd1  ,,,TAM_VALOR,nDecimais,.F.,cPicture,"2",,,,,,lPrintZero,.F.),TAM_VALOR) },.F.,.F.,.F.,oSection2)
		// 20/08/18 - Luis Felipe - Fim 
	EndIf
...
oSection1_1:Cell("SALDOANT"):SetBlock( {|| STR0033+" "+aCtbMoeda[3] +" "+ Alltrim(AsString(ValorCTB(aSaldoAnt[6],,,TAM_VALOR,nDecimais,.T.,cPicture,cNormal,,,,,,lPrintZero,.F.))) } )//"SALDO ANTERIOR: "
// 20/08/18 - Luis Felipe - Inicio
oSection1_1:Cell("SALDOANT1"):SetBlock( {|| STR0033+" U$ " + Alltrim(AsString(ValorCTB(aSaldoAnt1[6],,,TAM_VALOR,nDecimais,.T.,cPicture,cNormal,,,,,,lPrintZero,.F.))) } )//"SALDO ANTERIOR: "
// 20/08/18 - Luis Felipe - Fim
...
// 20/08/18 - Luis Felipe - Inicio
oSection1_1:Cell("SALDOANT1"):HideHeader() 
// 20/08/18 - Luis Felipe - Fim
	...
	Else
		...
		While lImpLivro .And. cArqTmp->(!Eof()) .And. !oReport:Cancel()
			...
			If lSldAntCC
                ...
                // 20/08/18 - Luis Felipe -  Inicio
				aSaldo1    := SaldTotCT3(cCustoIni,cCustoFim,cArqTmp->CONTA,cArqTmp->CONTA,cArqTmp->DATAL,"02",cSaldo,aSelFil)	
				aSaldoAnt1 := SaldTotCT3(cCustoIni,cCustoFim,cArqTmp->CONTA,cArqTmp->CONTA,dDataIni,"02",cSaldo,aSelFil)
                // 20/08/18 - Luis Felipe -  Fim
			...
			ElseIf lSldAntIt
                ...
                // 20/08/18 - Luis Felipe -  Inicio
				aSaldo1    := SaldTotCT4(cItemIni,cItemFim,cCustoIni,cCustoFim,cArqTmp->CONTA,cArqTmp->CONTA,cArqTmp->DATAL,"02",cSaldo,aSelFil)	
				aSaldoAnt1 := SaldTotCT4(cItemIni,cItemFim,cCustoIni,cCustoFim,cArqTmp->CONTA,cArqTmp->CONTA,dDataIni,"02",cSaldo,aSelFil)
                // 20/08/18 - Luis Felipe -  Fim
			...
			ElseIf lSldAntCv
                ...
                // 20/08/18 - Luis Felipe -  Inicio
				aSaldo1    := SaldTotCTI(cClVlIni,cClVlFim,cItemIni,cItemFim,cCustoIni,cCustoFim,cArqTmp->CONTA,cArqTmp->CONTA,cArqTmp->DATAL,"02",cSaldo,aSelFil)	
				aSaldoAnt1 := SaldTotCTI(cClVlIni,cClVlFim,cItemIni,cItemFim,cCustoIni,cCustoFim,cArqTmp->CONTA,cArqTmp->CONTA,dDataIni,"02",cSaldo,aSelFil)
                // 20/08/18 - Luis Felipe -  Fim
			...
			Else
				If lProcSld  // se existe parametro MV_CTBRAZD com .t. e conseguiu criar procedure
	                ...
	                // 20/08/18 - Luis Felipe -  Inicio
					aRet1  := {} 
					aRet1  := TcSpExec(cTmpProc, cFilAnt, "CQ1",cArqTmp->CONTA," "," ", " ",cSaldo,"02", Dtos(cArqTmp->DATAL)) 

					If Empty(aRet)
						aSaldo1 	:= SaldoCT7Fil(cArqTmp->CONTA,cArqTmp->DATAL,"02",cSaldo,,,,aSelFil,,lTodasFil)	
					Else 
						aSaldo1    := { aRet1[1], aRet1[2], aRet1[3], aRet1[4], aRet1[5], aRet1[6], aRet1[7],aRet1[8]}
					EndIf
	                // 20/08/18 - Luis Felipe -  Fim
	                ...
	                // 20/08/18 - Luis Felipe -  Inicio
					aRet1   := {}
					aRet1   := TcSpExec(cTmpProc, cFilAnt, "CQ1",cArqTmp->CONTA," "," ", " ",cSaldo,"02", Dtos(dDataIni))
					If Empty(aRet)
						aSaldoAnt1 		:= SaldoCT7Fil(cArqTmp->CONTA,cArqTmp->DATAL,"02",cSaldo,,,,aSelFil,,lTodasFil)	
					Else 
						aSaldoAnt1    := { aRet1[1], aRet1[2], aRet1[3], aRet1[4], aRet1[5], aRet1[6], aRet1[7],aRet1[8]}
					EndIf
	                // 20/08/18 - Luis Felipe -  Fim
				...
				Else
	                ...
	                // 20/08/18 - Luis Felipe -  Inicio
					aSaldo1 	:= SaldoCT7Fil(cArqTmp->CONTA,cArqTmp->DATAL,"02",cSaldo,,,,aSelFil,,lTodasFil)	
					aSaldoAnt1	:= SaldoCT7Fil(cArqTmp->CONTA,dDataIni,"02",cSaldo,"CTBR400",,,aSelFil,,lTodasFil)
	                // 20/08/18 - Luis Felipe -  Fim
			...
			oSection3:Cell("CTRANSP"):SetBlock( { || Iif(lDeTransp,  STR0023, STR0022)}) 
			...
			nSaldoAtu1 := aSaldoAnt1[6]   // 20/08/18 - Luis Felipe                                         
			//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
			//³FIM DA 1a SECAO³
			//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
			...
			Do While cArqTmp->(!Eof() .And. CONTA == cContaAnt ) .And. !oReport:Cancel()   
				...
				If mv_par08 < 3 //Se for relatorio analitico ou resumido  				
					...
					// 20/08/18 - Luis Felipe - Inicio
					nSaldoAtu1 	:= nSaldoAtu1 - cArqTmp->LANCDEB_1 + cArqTmp->LANCCRD_1
					nTotDeb1	+= cArqTmp->LANCDEB_1
					nTotCrd1	+= cArqTmp->LANCCRD_1
					nTotGerDeb1	+= cArqTmp->LANCDEB_1
					nTotGerCrd1	+= cArqTmp->LANCCRD_1			
					// 20/08/18 - Luis Felipe - Fim
					...
					// 20/08/18 - Luis Felipe - Inicio	
					oSection2:Cell("CTPSLDATU1"):SetBlock( { || ValorCTB(nSaldoAtu1,,,TAM_VALOR-2,nDecimais,.T.,cPicture,cNormal,,,,,,lPrintZero,.F.) } )
					// 20/08/18 - Luis Felipe - Fim
					...
					// 20/08/18 - Luis Felipe - Inicio	
					nSldTransp1 := nSaldoAtu1 // Valor a Transportar - 1
					// 20/08/18 - Luis Felipe - Fim
				...
				Else      // -- Se for sintetico                               			
					...
					While dDataAnt == cArqTmp->DATAL .And. cContaAnt == cArqTmp->CONTA
						...
						// 20/08/18 - Luis Felipe - Inicio
						nVlrDeb1	+= cArqTmp->LANCDEB_1		                                         
						nVlrCrd1	+= cArqTmp->LANCCRD_1		                                         
						nTotGerDeb1	+= cArqTmp->LANCDEB_1
						nTotGerCrd1	+= cArqTmp->LANCCRD_1			
						// 20/08/18 - Luis Felipe - Fim
					...
					oSection2:Cell("CTPSLDATU"):SetBlock( { || ValorCTB(nSaldoAtu,,,TAM_VALOR-2,nDecimais,.T.,cPicture,cNormal,,,,,,lPrintZero,.F.) })// Sinal do Saldo Atual => Consulta Razao
				  	...
				  	// 20/08/18 - Luis Felipe - Inicio
					nSaldoAtu1	:= nSaldoAtu1 - nVlrDeb1 + nVlrCrd1
				  	oSection2:Cell("CLANCDEB1"):SetBlock( { || ValorCTB(nVlrDeb1,,,TAM_VALOR,nDecimais,.F.,cPicture,"1",,,,,,lPrintZero,.F.) })// Debito
				  	oSection2:Cell("CLANCCRD1"):SetBlock( { || ValorCTB(nVlrCrd1,,,TAM_VALOR,nDecimais,.F.,cPicture,"2",,,,,,lPrintZero,.F.) })// Credito
					oSection2:Cell("CTPSLDATU1"):SetBlock( { || ValorCTB(nSaldoAtu1,,,TAM_VALOR-2,nDecimais,.T.,cPicture,cNormal,,,,,,lPrintZero,.F.) })// Sinal do Saldo Atual => Consulta Razao
				  	// 20/08/18 - Luis Felipe - Fim
					...
					nVlrCrd	:= 0
				  	...
				  	// 20/08/18 - Luis Felipe - Inicio
					nSldTransp1 := nSaldoAtu1 // Valor a Transportar  
		...
		If lImpLivro .And. mv_par28 == 1 .And. lImpTermos .And. oReport:nDevice != 4  	//Imprime total Geral  //diferente de excel
			...
			// 20/08/18 - Luis Felipe - Inicio
			oSection2:Cell("CLANCDEB1"):SetSize(0)
			oSection2:Cell("CLANCDEB1"):Disable()
			
			oSection2:Cell("CLANCCRD1"):SetSize(0)
			oSection2:Cell("CLANCCRD1"):Disable()
			
			oSection2:Cell("CTPSLDATU1"):SetSize(0)	
			oSection2:Cell("CTPSLDATU1"):Disable()
			// 20/08/18 - Luis Felipe - Fim
...
If lImpTermos .And. ! Empty(cArqAbert)	
	...
	oFwSX1Util:AddGroup("CTR400")
	oFwSX1Util:SearchGroup()
	aPergunte := oFwSX1Util:GetGroup("CTR400")
	If Len(aPergunte) >= 2
...
Default lAvancaReg := .T.
	...
	// 20/08/18 - Luis Felipe - Inicio
	oSection2:Cell("CLANCDEB1"	):Hide()
	oSection2:Cell("CLANCCRD1"	):Hide()
	oSection2:Cell("CTPSLDATU1"	):Hide()
	// 20/08/18 - Luis Felipe - Fim
	...
	// 20/08/18 - Luis Felipe  - Inicio
	oSection2:Cell("CLANCDEB1"	):Show()
	oSection2:Cell("CLANCCRD1"	):Show()
	oSection2:Cell("CTPSLDATU1"	):Show()
	// 20/08/18 - Luis Felipe  - Fim
...
// 20/08/18 - Luis Felipe - Inicio
#DEFINE 	COL_VLR_DEBITO1		10
#DEFINE 	COL_VLR_CREDITO1	11
#DEFINE 	COL_VLR_SALDO1 		12
// 20/08/18 - Luis Felipe - Fim

#DEFINE 	TAMANHO_TM       	10
#DEFINE 	COL_VLR_TRANSPORTE  13 // 20/08/18 - Luis Felipe - De 11 p/ 13
...
While lImpLivro .And. !cArqTmp->(Eof())
	...
	ElseIf lSldAntIt
		...
		// 20/08/18 - Luis Felipe - Fim
	ElseIf lSldAntCv
		aSaldo    := SaldTotCTI(cClVlIni,cClVlFim,cItemIni,cItemFim,cCustoIni,cCustoFim,cArqTmp->CONTA,cArqTmp->CONTA,cArqTmp->DATAL,"02",cSaldo,aSelFil)
		aSaldoAnt := SaldTotCTI(cClVlIni,cClVlFim,cItemIni,cItemFim,cCustoIni,cCustoFim,cArqTmp->CONTA,cArqTmp->CONTA,dDataIni,"02",cSaldo,aSelFil)

		// 20/08/18 - Luis Felipe - Inicio
		aSaldo1    := SaldTotCTI(cClVlIni,cClVlFim,cItemIni,cItemFim,cCustoIni,cCustoFim,cArqTmp->CONTA,cArqTmp->CONTA,cArqTmp->DATAL,cMoeda,cSaldo,aSelFil)
		aSaldoAnt1 := SaldTotCTI(cClVlIni,cClVlFim,cItemIni,cItemFim,cCustoIni,cCustoFim,cArqTmp->CONTA,cArqTmp->CONTA,dDataIni,cMoeda,cSaldo,aSelFil)
		// 20/08/18 - Luis Felipe - Fim
	Else
		...
		// 20/08/18 - Luis Felipe - Inicio
		aSaldo1 	:= SaldoCT7Fil(cArqTmp->CONTA,cArqTmp->DATAL,"02",cSaldo,,,,aSelFil)
		aSaldoAnt1	:= SaldoCT7Fil(cArqTmp->CONTA,dDataIni,"02",cSaldo,"CTBR400",,,aSelFil)
		// 20/08/18 - Luis Felipe - Fim
	EndIf
    ...
    // 20/08/18 - Luis Felipe - Inicio
	ValorCTB(aSaldoAnt1[6],li,aColunas[COL_VLR_SALDO1],aColunas[TAMANHO_TM],nDecimais,;
							         .T.,cPicture, cNormal, , , , , ,lPrintZero)

	nSaldoAtu1 := aSaldoAnt1[6]                                           
    // 20/08/18 - Luis Felipe - Fim
	...
	While cArqTmp->(!Eof()) .And. cArqTmp->CONTA == cContaAnt
		...
		If li > nMaxLin
            ...
            // 20/08/18 - Luis Felipe - Inicio
			ValorCTB(nSaldoAtu1,li,aColunas[COL_VLR_SALDO1],;
					   aColunas[TAMANHO_TM],nDecimais, .T.,cPicture,cNormal , , , , , ,lPrintZero)
            // 20/08/18 - Luis Felipe - fim
            ...
            // 20/08/18 - Luis Felipe - Inicio
			ValorCTB(nSaldoAtu1,li,aColunas[COL_VLR_SALDO1],aColunas[TAMANHO_TM],nDecimais, .T.,cPicture,cNormal , , , , , ,lPrintZero)
            // 20/08/18 - Luis Felipe - Fim
		...
		If nTipoRel < 3	//Se for relatorio analitico ou resumido
            ...
            // 20/08/18 - Luis Felipe - Inicio
			ValorCTB(cArqTmp->LANCDEB_1,li,aColunas[COL_VLR_DEBITO1] 	, aColunas[TAMANHO_TM],nDecimais,.F.,cPicture,"1", , , , , ,lPrintZero)
			ValorCTB(cArqTmp->LANCCRD_1,li,aColunas[COL_VLR_CREDITO1]	, aColunas[TAMANHO_TM],nDecimais,.F.,cPicture,"2", , , , , ,lPrintZero)
			ValorCTB(nSaldoAtu1,li,aColunas[COL_VLR_SALDO1]			, aColunas[TAMANHO_TM],nDecimais,.T.,cPicture,cNormal, , , , , ,lPrintZero)
            // 20/08/18 - Luis Felipe - Fim
		...
		Else		// Se for sintetico.                               			
            ...
            // 20/08/18 - Luis Felipe - Inicio
			nSaldoAtu1:= nSaldoAtu1 - nVlrDeb1 + nVlrCrd1
			ValorCTB(nVlrDeb1,li,aColunas[COL_VLR_DEBITO1],aColunas[TAMANHO_TM],;
				nDecimais,.F.,cPicture,"1", , , , , ,lPrintZero)
			ValorCTB(nVlrCrd1,li,aColunas[COL_VLR_CREDITO1],aColunas[TAMANHO_TM],;
				nDecimais,.F.,cPicture,"2", , , , , ,lPrintZero)
			ValorCTB(nSaldoAtu1,li,aColunas[COL_VLR_SALDO1],aColunas[TAMANHO_TM],;
				nDecimais,.T.,cPicture,cNormal, , , , , ,lPrintZero)
			nTotDeb1	+= nVlrDeb1
			nTotCrd1	+= nVlrCrd1         
			nVlrDeb1	:= 0
   ...
   EndIf
    ...
    // 20/08/18 - Luis Felipe - Inicio
	ValorCTB(nTotDeb1,li,aColunas[COL_VLR_DEBITO1],aColunas[TAMANHO_TM],nDecimais,;
			 .F.,cPicture,"1", , , , , ,lPrintZero)
	ValorCTB(nTotCrd1,li,aColunas[COL_VLR_CREDITO1],aColunas[TAMANHO_TM],nDecimais,;
			 .F.,cPicture,"2", , , , , ,lPrintZero)
	ValorCTB(nSaldoAtu1,li,aColunas[COL_VLR_SALDO1],aColunas[TAMANHO_TM],nDecimais,;
			 .T.,cPicture,cNormal, , , , , ,lPrintZero)
    // 20/08/18 - Luis Felipe - Fim
...
If li != 80 .And. lImpLivro .And. mv_par28 == 1	//Imprime total Geral
	...
	If lAnalitico .And. (lCusto .Or. lItem .Or. lClVl)
		...
		// 20/08/18 - Luis Felipe - Inicio
		ValorCTB(nTotGerDeb1,li,aColunas[COL_VLR_DEBITO1],aColunas[TAMANHO_TM],nDecimais,.F.,cPicture,"1", , , , , ,lPrintZero)
		ValorCTB(nTotGerCrd1,li,aColunas[COL_VLR_CREDITO1],aColunas[TAMANHO_TM],nDecimais,.F.,cPicture,"2", , , , , ,lPrintZero)
		// 20/08/18 - Luis Felipe - Fim
...
If lNumAsto .and. FunName() == "CTBR400" 
	IF Type("nTipoRel") = "U" 
		nTipoRel := MV_PAR08
	EndIf
	If nTipoRel == 1 
...
ElseIf cTipo == "4"		//Razao por Classe de Valor	
	If lAnalit 				// Se o relatorio for analitico               
		...
		Else
			...
			aChave	 :=  {"CLVL","CONTA","DATAL","LOTE","SUBLOTE","DOC","EMPORI","FILORI","LINHA"}
		EndIf
	Else                                                                  
...
Else
	...
	//ConOut( " INICIO Cria/Popula Temp no Banco : "+ Time())
	...
	CtbAuxRazao(@cContaIni,@cContaFim,@cCustoIni,@cCustoFim,;
				@cItemIni,@cItemFim,@cCLVLIni,@cCLVLFim,@cMoeda,@dDataIni,@dDataFim,;
				@aSetOfBook,@lNoMov,@cSaldo,@lJunta,@cTipo,@c2Moeda,@nTipo,@cUFilter,@lSldAnt,@aSelFil,@lExterno,@cArqTmp)
	//ConOut( " FIM Cria/Popula Temp no Banco   : "+ Time())
...
Else	//Se for Razao em 2 Moedas
	If (nTipo = 1 .Or. nTipo = 3) .And. (cAliasCT2)->CT2_MOEDLC = cMoeda //Se Imprime Valor na Moeda ou ambos
		...
		EndIf
	EndIf
//    If (nTipo = 2 .Or. nTipo = 3) .And. (cAliasCT2)->CT2_MOEDLC = c2Moeda	//Se Imprime Moeda Corrente ou Ambas // 20/08/18 - Luis Felipe
    If (nTipo = 1 .Or. nTipo = 3) .And. (cAliasCT2)->CT2_MOEDLC = c2Moeda	//Se Imprime Moeda Corrente ou Ambas
		If cTipo == "1"
...
While !Eof()                                              
	...
	If &("cArqCT2->("+cUFilter+")")						
		...
		Else
            ...
            // 20/08/18 - Luis Felipe - Inicio
			If cArqCT2->TIPOLAN = '1'
				Replace LANCDEB_1	With LANCDEB_1 + cArqCT2->VALOR
			EndIf
			If cArqCT2->TIPOLAN = '2'
				Replace LANCCRD_1	With LANCCRD_1 + cArqCT2->VALOR
			EndIf	
            // 20/08/18 - Luis Felipe - Fim
...
cRngCTDFil := GetRngFil( aSelFil ,"CT1", .T., @cTmpCTTFil)
...
If cTipo == "1"
	...
	//cOrderBy:= " CT2_FILIAL, CT2_DEBITO, CT2_DATA "+CRLF
...
If FunName() == "CTBR400" .OR. IsInCallStack("CT400Imp")
	...
	cProcCT2 += "       AND CT2_DC = '4' "+ CRLF    //SOMENTE CONTINUACAO DE HISTORICO
	cProcCT2 += "       AND CT2.D_E_L_E_T_ = ' ' "+ CRLF
	cProcCT2 += "       AND CARQTMP.D_E_L_E_T_ = ' ' "+ CRLF
	cProcCT2 += "    ORDER BY CT2_FILIAL, CT2_DATA, CT2_LOTE, CT2_SBLOTE, CT2_DOC, CT2_LINHA, CT2_SEQHIS "+ CRLF
	...
	cProcCT2 += "	begin"+CRLF
	cProcCT2 += CRLF
	//pegar CT2_SEQLAN e inserir no arquivo temporario as continuacoes de historico
...
//			cProcCT2	+= " SELECT DISTINCT XFILCT2.TMPFIL CT2_FILIAL, CT1_CONTA  "  //ORIGINAL
			cProcCT2 += "    SELECT DISTINCT CT1_CONTA  " 
			cProcCT2 += "      FROM "+RetSqlName("CT1")+ " CT1,  "
			cProcCT2 += " "+cRealTmp+ " XFILCT2  "
			//aqui colocar o xfilial da CT1 
//			If Empty(xFilial("CT1"))  ORIGINAL
				cProcCT2 += "     WHERE CT1_FILIAL = '"+xFilial("CT1")+"' "+ CRLF  //COMPARTILHADO CT1
/*			Else
				cProcCT2 += " WHERE CT1_FILIAL " + cRngFilCT1 +CRLF //EXCLUSIVO CT1
			EndIf*/	
...
If !Empty(c2Moeda)
	...
	//cProcCT2 += "    SELECT @fim_CUR = 0 "+CRLF
	If cTipo == "1"
...
If lCtbRazBD == NIL //RECEBERA MV_CTBRAZB (L) 
	If Alltrim(TCGetDb())$"MSSQL7|ORACLE|DB2|INFORMIX" 
		If FunName()=="CTBR400" .Or. FWIsInCallStack("CTBR400")
			_lRet := MV_PAR38 == 1 .And. GetMV("MV_CTBRAZB",,.F.)
		EndIf
	EndIf
Else
	_lRet := lCtbRazBD

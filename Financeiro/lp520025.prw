...
//ALTERAÇÃO 200117 -- _nRet := IF((FORMULA("TXB")+FORMULA("TXC")*-1)>0.AND.SE1->E1_PREFIXO="EEC".AND.SE1->E1_MOEDA=2,((SE5->E5_VLMOED2*SE5->E5_TXMOEDA)-(SE5->E5_VLMOED2*SE1->E1_TXMOED2)),0)                                                                                     

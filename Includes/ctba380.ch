	...
	#define STR0024 "Verifique la creacion de los campos CTH_CLVM y CTH_CLRED."
		...
		#define STR0017 "Moeda nao podera ser '01'."
		#define STR0018 "Considera CCusto ?"
		#define STR0019 "Considera Item Cta?"
		#define STR0020 "Considera Cl.Valor?"
		#define STR0021 "Verifique a criação dos campos CTT_CCVM e CTT_CCRED."
		#define STR0022 "Contate o Administrador."
		#define STR0023 "Verifique a criação dos campos CTD_ITVM e CTD_ITRED."
		#define STR0024 "Verifique a criação dos campos CTH_CLVM e CTH_CLRED."
	#endif
#endif
